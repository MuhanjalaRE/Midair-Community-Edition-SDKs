...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_YPQT[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_PWMY[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_A2HZ[0xD0];                                    // 0x0000(0x00D0) MISSED OFFSET (PADDING)
