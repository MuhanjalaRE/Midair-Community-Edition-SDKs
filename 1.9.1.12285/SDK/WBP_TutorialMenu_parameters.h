...
struct UWBP_TutorialMenu_C_BndEvt__Tut_Movement_K2Node_ComponentBoundEvent_67_ButtonClicked__DelegateSignature_Params
{
...
struct UWBP_TutorialMenu_C_BndEvt__Tut_Shooting_K2Node_ComponentBoundEvent_76_ButtonClicked__DelegateSignature_Params
{
	class UWBP_SelectableButton_C*                     Clicked_Button;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function WBP_TutorialMenu.WBP_TutorialMenu_C.ExecuteUbergraph_WBP_TutorialMenu
struct UWBP_TutorialMenu_C_ExecuteUbergraph_WBP_TutorialMenu_Params
{
