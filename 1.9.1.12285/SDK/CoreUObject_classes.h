...
{
public:
	unsigned char                                      UnknownData_KWDW[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_W37U[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QJZN[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K5BU[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1689[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WWLF[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4C0K[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_E9ND[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5GWY[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K3SN[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4L43[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_22UZ[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3LW9[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_15D4[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CL9E[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N9HL[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PAKU[0x68];                                    // 0x0028(0x0068) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_ER614HCRUP[0x01];                                      // 0x009F(0x0001) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_LLQPR3474S[0x04];                                      // 0x00BC(0x0004) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_YDKY[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_U1YX[0x168];                                   // 0x0098(0x0168) MISSED OFFSET (PADDING)
...
template<typename T>
	...
	{
		// return nullptr;
		GetVFunction<UObject*(*)(UClass*)>(this, 107)(this);
	}
...
{
public:
	unsigned char                                      UnknownData_XESY[0x68];                                    // 0x0200(0x0068) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QCRQ[0xB8];                                    // 0x0028(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CM0B[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NC66[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JDN5[0x1B8];                                   // 0x0200(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F2XB[0xC8];                                    // 0x0028(0x00C8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8DZB[0x1B8];                                   // 0x00C8(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V5ZL[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BY63[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
