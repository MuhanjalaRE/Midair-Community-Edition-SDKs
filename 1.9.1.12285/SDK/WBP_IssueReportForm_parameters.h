...
struct UWBP_IssueReportForm_C_OnFail_AF91C2684799695ADBF1D1BBC53F98F2_Params
{
};

// Function WBP_IssueReportForm.WBP_IssueReportForm_C.OnSuccess_AF91C2684799695ADBF1D1BBC53F98F2
struct UWBP_IssueReportForm_C_OnSuccess_AF91C2684799695ADBF1D1BBC53F98F2_Params
{
};
...
struct UWBP_IssueReportForm_C_BndEvt__CancelButton_K2Node_ComponentBoundEvent_26_OnButtonClickedEvent__DelegateSignature_Params
{
};
...
struct UWBP_IssueReportForm_C_BndEvt__OkButton_K2Node_ComponentBoundEvent_61_OnButtonClickedEvent__DelegateSignature_Params
{
};
...
struct UWBP_IssueReportForm_C_BndEvt__ReproduceTextBox_K2Node_ComponentBoundEvent_2_OnMultiLineEditableTextBoxChangedEvent__DelegateSignature_Params
{
...
struct UWBP_IssueReportForm_C_BndEvt__DescriptionTextBox_K2Node_ComponentBoundEvent_7_OnMultiLineEditableTextBoxChangedEvent__DelegateSignature_Params
{
	struct FText                                       Text;                                                      // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
struct UWBP_IssueReportForm_C_BndEvt__SummaryTextBox_K2Node_ComponentBoundEvent_15_OnEditableTextBoxChangedEvent__DelegateSignature_Params
{
	struct FText                                       Text;                                                      // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};

// Function WBP_IssueReportForm.WBP_IssueReportForm_C.Construct
struct UWBP_IssueReportForm_C_Construct_Params
{
};

// Function WBP_IssueReportForm.WBP_IssueReportForm_C.ExecuteUbergraph_WBP_IssueReportForm
struct UWBP_IssueReportForm_C_ExecuteUbergraph_WBP_IssueReportForm_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function WBP_IssueReportForm.WBP_IssueReportForm_C.OnConnect__DelegateSignature
struct UWBP_IssueReportForm_C_OnConnect__DelegateSignature_Params
{
