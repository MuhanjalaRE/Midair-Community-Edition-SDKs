...
struct UWBP_MidairCombobox_Item_C_Construct_Params
{
};
...
struct UWBP_MidairCombobox_Item_C_BndEvt__WBP_StyledButton_K2Node_ComponentBoundEvent_0_Clicked__DelegateSignature_Params
{
...
struct UWBP_MidairCombobox_Item_C_ExecuteUbergraph_WBP_MidairCombobox_Item_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function WBP_MidairCombobox_Item.WBP_MidairCombobox_Item_C.Selected__DelegateSignature
struct UWBP_MidairCombobox_Item_C_Selected__DelegateSignature_Params
{
	int                                                Ident;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
