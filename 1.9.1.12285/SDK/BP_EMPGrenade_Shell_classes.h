...
{
public:
	unsigned char                                      UnknownData_ZH8X[0x8];                                     // 0x0808(0x0008) Fix Super Size
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr){
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_EMPGrenade_Shell.BP_EMPGrenade_Shell_C");
		}
		return ptr;
	}
