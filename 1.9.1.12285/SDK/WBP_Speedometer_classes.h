...
// WidgetBlueprintGeneratedClass WBP_Speedometer.WBP_Speedometer_C
// 0x0010 (FullSize[0x0248] - InheritedSize[0x0238])
class UWBP_Speedometer_C : public UUserWidget
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr){
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WBP_Speedometer.WBP_Speedometer_C");
		}
		return ptr;
	}
