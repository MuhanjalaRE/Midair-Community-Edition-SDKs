...
{
public:
	unsigned char                                      UnknownData_4S2B[0x8];                                     // 0x0808(0x0008) Fix Super Size
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr){
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_ConcGrenadeShell.BP_ConcGrenadeShell_C");
		}
		return ptr;
	}
