...
struct UWBP_VideoSettings_C_BndEvt__FPS_Slider_K2Node_ComponentBoundEvent_1_ValueApplied__DelegateSignature_Params
{
	float                                              NewValue;                                                  // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UWBP_VideoSettings_C_BndEvt__FPS_Slider_K2Node_ComponentBoundEvent_2_ValueAdjusted__DelegateSignature_Params
{
	float                                              NewValue;                                                  // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
