...
struct UWBP_Loadouts_SimpleVoiceListItem_C_OnMouseButtonUp_1_Params
{
	struct FGeometry                                   MyGeometry;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	struct FPointerEvent                               MouseEvent;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FEventReply                                 ReturnValue;                                               // (Parm, OutParm, ReturnParm)
...
struct UWBP_Loadouts_SimpleVoiceListItem_C_OnMouseButtonDown_1_Params
{
	struct FGeometry                                   MyGeometry;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	struct FPointerEvent                               MouseEvent;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FEventReply                                 ReturnValue;                                               // (Parm, OutParm, ReturnParm)
...
struct UWBP_Loadouts_SimpleVoiceListItem_C_Get_ItemName_ColorAndOpacity_1_Params
{
	struct FSlateColor                                 ReturnValue;                                               // (Parm, OutParm, ReturnParm)
};

// Function WBP_Loadouts_SimpleVoiceListItem.WBP_Loadouts_SimpleVoiceListItem_C.Update Item Info
struct UWBP_Loadouts_SimpleVoiceListItem_C_Update_Item_Info_Params
{
...
struct UWBP_Loadouts_SimpleVoiceListItem_C_Construct_Params
{
};

// Function WBP_Loadouts_SimpleVoiceListItem.WBP_Loadouts_SimpleVoiceListItem_C.Tick
struct UWBP_Loadouts_SimpleVoiceListItem_C_Tick_Params
{
	struct FGeometry                                   MyGeometry;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
...
struct UWBP_Loadouts_SimpleVoiceListItem_C_BndEvt__UnlockButton_K2Node_ComponentBoundEvent_35_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function WBP_Loadouts_SimpleVoiceListItem.WBP_Loadouts_SimpleVoiceListItem_C.OnMouseEnter
struct UWBP_Loadouts_SimpleVoiceListItem_C_OnMouseEnter_Params
{
	struct FGeometry                                   MyGeometry;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
...
struct UWBP_Loadouts_SimpleVoiceListItem_C_ExecuteUbergraph_WBP_Loadouts_SimpleVoiceListItem_Params
{
...
struct UWBP_Loadouts_SimpleVoiceListItem_C_JumpToAugment__DelegateSignature_Params
{
