...
struct UWBP_DrillRow_C_Get_DrillNameText_Text_1_Params
{
	struct FText                                       ReturnValue;                                               // (Parm, OutParm, ReturnParm)
};

// Function WBP_DrillRow.WBP_DrillRow_C.GetMAPracticeComponentForWidget
struct UWBP_DrillRow_C_GetMAPracticeComponentForWidget_Params
{
...
struct UWBP_DrillRow_C_SetRouteTrail_Params
{
...
struct UWBP_DrillRow_C_BndEvt__LoadRouteTrailButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};
...
struct UWBP_DrillRow_C_BndEvt__DeleteRouteTrailButton_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function WBP_DrillRow.WBP_DrillRow_C.ExecuteUbergraph_WBP_DrillRow
struct UWBP_DrillRow_C_ExecuteUbergraph_WBP_DrillRow_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function WBP_DrillRow.WBP_DrillRow_C.NewEventDispatcher_0__DelegateSignature
struct UWBP_DrillRow_C_NewEventDispatcher_0__DelegateSignature_Params
{
};
