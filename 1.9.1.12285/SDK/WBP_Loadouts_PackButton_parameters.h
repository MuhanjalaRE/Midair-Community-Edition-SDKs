...
struct UWBP_Loadouts_PackButton_C_SetPackInfoFromLoadout_Params
{
...
struct UWBP_Loadouts_PackButton_C_GetForegroundColor_1_Params
{
	struct FSlateColor                                 ReturnValue;                                               // (Parm, OutParm, ReturnParm)
};

// Function WBP_Loadouts_PackButton.WBP_Loadouts_PackButton_C.GetBackgroundColor_1
struct UWBP_Loadouts_PackButton_C_GetBackgroundColor_1_Params
{
...
struct UWBP_Loadouts_PackButton_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_26_OnButtonPressedEvent__DelegateSignature_Params
{
};
...
struct UWBP_Loadouts_PackButton_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_40_OnButtonReleasedEvent__DelegateSignature_Params
{
};
...
struct UWBP_Loadouts_PackButton_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_22_OnButtonClickedEvent__DelegateSignature_Params
{
};
...
struct UWBP_Loadouts_PackButton_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature_Params
{
};

// Function WBP_Loadouts_PackButton.WBP_Loadouts_PackButton_C.ExecuteUbergraph_WBP_Loadouts_PackButton
struct UWBP_Loadouts_PackButton_C_ExecuteUbergraph_WBP_Loadouts_PackButton_Params
{
	int                                                EntryPoint;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function WBP_Loadouts_PackButton.WBP_Loadouts_PackButton_C.OnClicked__DelegateSignature
struct UWBP_Loadouts_PackButton_C_OnClicked__DelegateSignature_Params
{
};
