...
// BlueprintGeneratedClass BP_RingLauncher_Explosion.BP_RingLauncher_Explosion_C
// 0x0018 (FullSize[0x0268] - InheritedSize[0x0250])
class ABP_RingLauncher_Explosion_C : public AMAImpactEffect
{
public:
	...
	static UClass* StaticClass()
	{
		...
		if(!ptr){
			ptr = UObject::FindClass("BlueprintGeneratedClass BP_RingLauncher_Explosion.BP_RingLauncher_Explosion_C");
		}
		return ptr;
	}
