...
struct UFindSessionsCallbackProxy_IsTournamentModeEnabled_Params
{
...
struct UFindSessionsCallbackProxy_IsPasswordProtected_Params
{
	struct FBlueprintSessionResult                     Result;                                                    // (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                               ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct UFindSessionsCallbackProxy_GetOfficialServer_Params
{
	struct FBlueprintSessionResult                     Result;                                                    // (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                               ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct UFindSessionsCallbackProxy_GetMapName_Params
{
	struct FBlueprintSessionResult                     Result;                                                    // (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FString                                     ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
