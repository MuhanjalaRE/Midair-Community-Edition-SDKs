...
{
public:
	unsigned char                                      UnknownData_HGSK[0xC0];                                    // 0x0028(0x00C0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CDEN[0x10];                                    // 0x00E8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MQKN[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XKLW[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KUE9[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T9XQ[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XV6O[0x128];                                   // 0x0028(0x0128) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N4EX[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WJB6[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3RMQ[0x2];                                     // 0x0060(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6AIZ[0x13D];                                   // 0x0063(0x013D) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JI8F[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I8RO[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q591[0x77];                                    // 0x0119(0x0077) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WU7M[0x8];                                     // 0x0198(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I3IH[0xF8];                                    // 0x01A8(0x00F8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RUZH[0x40];                                    // 0x0028(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_72B4[0x80];                                    // 0x0070(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F8EO[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N0G0[0x50];                                    // 0x0078(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JJKJ[0xF0];                                    // 0x00D8(0x00F0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UA6D[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LTN2[0x7];                                     // 0x0169(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7U7P[0x60];                                    // 0x01C0(0x0060) MISSED OFFSET (PADDING)
