...
{
public:
	unsigned char                                      UnknownData_ZB5I[0x8];                                     // 0x0438(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_SM45[0x6];                                     // 0x0442(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<struct FProcMeshSection>                    ProcMeshSections;                                          // 0x0450(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FKConvexElem>                        CollisionConvexElems;                                      // 0x0460(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	...
	unsigned char                                      UnknownData_8AKU[0x4];                                     // 0x048C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UBodySetup*>                          AsyncBodySetupQueue;                                       // 0x0490(0x0010) (ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
